...
By default, all CSS and JavaScript file paths are exported from the asset bundle, but you can override this behavior
by specifying the list of exported file paths in the `$export` property.
